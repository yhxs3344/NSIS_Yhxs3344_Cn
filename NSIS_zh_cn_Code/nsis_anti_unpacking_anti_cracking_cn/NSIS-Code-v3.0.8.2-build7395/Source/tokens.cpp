...
{TOK_STUBFILE,_T("StubFile"),1,-1,_T("[/nonfatal] [/a] ([/r] [/x 文件规范 [...]] 文件规范 [...] |\n   /oname=输出文件 仅一个文件)"),TP_CODE},
...
{TOK_RESERVESTUBFILE,_T("ReserveStubFile"),1,-1,_T("[/nonfatal] [/r] [/x 文件规范 [...]] 文件 [文件...] | [/nonfatal] /plugin 文件.dll"),TP_ALL},
...
{TOK_VERIFYEXTERNALFILE,_T("VerifyExternalFile"),0,1,_T("[$(用户变量: 文件名 输入)]"),TP_CODE},
