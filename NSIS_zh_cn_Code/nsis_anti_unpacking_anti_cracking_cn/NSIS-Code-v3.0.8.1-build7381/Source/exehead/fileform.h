...
#ifdef NSIS_CONFIG_LARGE_FILE_SUPPORT
#  define FIRST_INT_TYPE INT64 // must be a signed type for error handling to work properly
#  ifdef _MSC_VER // old mingw32 doesn't have i64 support, and a typecast doesn't work either
#    define FIRST_INT_MAXDATA 0x7ffffffffffffff7i64 // LLONG_MAX - sizeof(INT64)
#    define FIRST_INT_FLAG    0x8000000000000000i64
#    define FIRST_INT_MASK    0x7fffffffffffffffi64
#  else
#    define FIRST_INT_MAXDATA 0x7ffffffffffffff7LL // LLONG_MAX - sizeof(INT64)
...
#else
#  define FIRST_INT_TYPE INT32 // must be a signed type for error handling to work properly
#  define FIRST_INT_MAXDATA 0x7ffffffb // INT_MAX - sizeof(INT32)
#  define FIRST_INT_FLAG    0x80000000
#  define FIRST_INT_MASK    0x7fffffff
#  define FIRST_INT_FIX_ENDIAN FIX_ENDIAN_INT32
#endif
...
enum
{
  ...
  EW_EXTRACTFILE,       // File to extract: 8 [overwriteflag, output filename, compressed filedata low, compressed filedata high, filedatetimelow, filedatetimehigh, allow ignore, crc]
                        //  overwriteflag: 0x1 = no. 0x0=force, 0x2=try, 0x3=if date is newer
#ifdef NSIS_CONFIG_EXTERNAL_FILE_SUPPORT
  EW_EXTRACTSTUBFILE,   // File to extract: 8 [overwriteflag, output filename, compressed filedata low, compressed filedata high, filedatetimelow, filedatetimehigh, allow ignore, crc]
                        //  overwriteflag: 0x1 = no. 0x0=force, 0x2=try, 0x3=if date is newer
  EW_VERIFYEXTERNALFILE,// VerifyExternalFile: 1 [path_to_file]
#endif
#endif
  ...
  EW_WRITEREG,          // Write Registry value: 7, [RootKey(int),KeyName,ItemName,ItemDataLow,[ItemDataHigh],typelen,[crc]]
  ...
  EW_WRITEUNINSTALLER,  // WriteUninstaller: 6 [name, offsetlow, offsethigh, icon_size, crc icons, crc data]
#endif
...
#endif
#define FH_FLAGS_LONG_DB_OFFSET 16
#ifdef NSIS_CONFIG_LARGE_FILE_SOURCE
#  define FH_FLAGS_LARGE_FILE_SOURCE 32
#endif
#ifdef NSIS_CONFIG_EXTERNAL_FILE_SUPPORT
...
#ifdef NSIS_CONFIG_EXTERNAL_FILE_SUPPORT
extern int g_has_external_file;
extern int g_is_stub_installer;
#endif //NSIS_CONFIG_EXTERNAL_FILE_SUPPORT
