...
{TOK_STUBFILE,_T("StubFile"),1,-1,_T("[/nonfatal] [/a] ([/r] [/x filespec [...]] filespec [...] |\n   /oname=outfile one_file_only)"),TP_CODE},
...
{TOK_RESERVESTUBFILE,_T("ReserveStubFile"),1,-1,_T("[/nonfatal] [/r] [/x filespec [...]] file [file...] | [/nonfatal] /plugin file.dll"),TP_ALL},
...
{TOK_VERIFYEXTERNALFILE,_T("VerifyExternalFile"),0,1,_T("[$(user_var: filename input)]"),TP_CODE},
