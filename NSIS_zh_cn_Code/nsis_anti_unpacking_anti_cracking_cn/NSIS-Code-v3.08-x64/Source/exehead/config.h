...
#include <nsis-sconf.h>
  ...
  #define _NSIS_CONFIG_UNINSTDLG
          ...
          #ifndef NSIS_COMPRESS_USE_LZ4
            #error compression is enabled but zlib, bzip2, lzma and lz4 are disabled.
          #endif
        #endif
      #endif
    #endif
      ...
      #error both zlib and lz4 are enabled.
    #endif
  #endif
  #ifdef NSIS_COMPRESS_USE_BZIP2
    #ifdef NSIS_COMPRESS_USE_LZMA
    ...
    #endif
    #ifdef NSIS_COMPRESS_USE_LZ4
      #error both bzip2 and lz4 are enabled.
    #endif
  #endif
  #ifdef NSIS_COMPRESS_USE_LZMA
    #ifdef NSIS_COMPRESS_USE_LZ4
      #error both lzma and lz4 are enabled.
    #endif
  #endif
