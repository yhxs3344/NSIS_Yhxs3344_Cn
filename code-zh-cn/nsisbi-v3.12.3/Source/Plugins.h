...
class Plugins
{
  public:
    ...
    DB_OFFSET GetDllDataHandle(bool uninst, const tstring& command) const;
    crc32_t GetDllCRCValue(bool uninst, const tstring& command) const;
    void SetDllDataHandle(bool uninst, tstring&canoniccmd, DB_OFFSET dataHandle, crc32_t crc);
  ...
  private: // data members
    ...
    std::map<tstring, DB_OFFSET, strnocasecmp> m_dllname_to_inst_datahandle;
    std::map<tstring, DB_OFFSET, strnocasecmp> m_dllname_to_unst_datahandle;
