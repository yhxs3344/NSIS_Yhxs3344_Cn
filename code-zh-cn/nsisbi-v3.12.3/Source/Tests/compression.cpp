...
#define IsBug1156(r) ( ((r) & 0x80) == 0x80 )
  ...
  void testCompressDecompress(ICompressor &compressor, IDecompressor& decompressor) {
    CPPUNIT_ASSERT_EQUAL( C_OK, compressor.Init(9, 1 << 23, 2) );
...
class lz4CompressionTest : public CompressionTest {

  CPPUNIT_TEST_SUITE( lz4CompressionTest );
  CPPUNIT_TEST( test );
  CPPUNIT_TEST_SUITE_END();
...
CPPUNIT_TEST_SUITE_REGISTRATION( lz4CompressionTest );
