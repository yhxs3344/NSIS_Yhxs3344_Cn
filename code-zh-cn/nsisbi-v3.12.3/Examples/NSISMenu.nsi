...
VIAddVersionKey "ProductName" "NSISBI"
VIAddVersionKey "ProductVersion" "${VERSTR}"
VIAddVersionKey "FileVersion" "${VERSTR}"
VIAddVersionKey "FileDescription" "NSISBI Menu"
...
!define WWW "http://sf.net/projects/nsisbi"
...
!searchreplace VERSTR "${NSIS_VERSION}" "v" ""
nsDialogs::CreateControl ${__NSD_Label_CLASS} ${__NSD_Label_STYLE}|${SS_CENTERIMAGE}|${SS_ENDELLIPSIS} ${__NSD_Label_EXSTYLE} 34u 1u -34u ${UY_HEADER}u "NSISBI (Big Install) ${VERSTR}"
Pop $0
SetCtlColors $0 0x3A2A42 transparent
SendMessage $0 ${WM_SETFONT} $1 1
nsDialogs::CreateControl ${__NSD_Label_CLASS} ${__NSD_Label_STYLE}|${SS_CENTERIMAGE}|${SS_ENDELLIPSIS} ${__NSD_Label_EXSTYLE} 33u 0 -33u ${UY_HEADER}u "NSISBI (Big Install) ${VERSTR}"
Pop $0
...
!insertmacro CreateControl Label "Many more examples, tutorials, plug-ins and NSIS/NSISBI-related software are available at the online Developer Center." ${UX_W} ${UY_MULTILINE}
Pop $0
...
!insertmacro CreateSimpleLink "NSISBI Users Manual" "${PR}\NSIS.chm|${WWW}/Docs/" ${UX_W}
...
!insertmacro CreatePluginLink "EnVar"     "modify environment paths"    "${PD}\EnVar\readme.txt"
...
nsDialogs::CreateControl ${__NSD_Label_CLASS} ${__NSD_Label_STYLE}|${SS_CENTERIMAGE}|${SS_NOTIFY} ${__NSD_Label_EXSTYLE} -110u -20u 100% 20u "sf.net/projects/nsisbi"
Pop $0
${SetCtlColors} $0 ${CT_FOOTER} transparent transparent
SendMessage $0 ${WM_SETFONT} ${HF_HEADER} 1
nsDialogs::SetUserData $0 "https://sf.net/projects/nsisbi"
