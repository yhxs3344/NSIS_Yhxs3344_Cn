// Copyright (C) 2018-2026 Anders Kjersem
//
...
#if defined(_MSC_VER) && _MSC_VER >= 1400 && defined(__MINGW32_MAJOR_VERSION) && !defined(__MINGW64_VERSION_MAJOR) && (!defined(_WIN32_WINNT) || (_WIN32_WINNT < 0x0500))
...
{
#if defined(_MSC_VER) && _MSC_VER >= 1400 && !(defined(__MINGW32_MAJOR_VERSION) && !defined(__MINGW64_VERSION_MAJOR) && (__MINGW32_MINOR_VERSION <= 15))
